header Kernel
  ...
  class HoareCondition
    ...
    methods
      Init ()
      Wait (mutex: ptr to HoareMutex, next: ptr to HoareMutex, next_count: ptr to int)
      Signal (next: ptr to HoareMutex, next_count: ptr to int)
  endClass
