...
-----------------------------  ProducerConsumer  ---------------------------------
  ...
  var
    lockMutex: Mutex = new Mutex  -- defined Mutex by me
    fullBuffer: Semaphore = new Semaphore   -- defined Semaphore by me according to course slides
    emptyBuffer: Semaphore = new Semaphore    -- defined Semaphore by me according to course slides
...
-----------------------------  Dining Philosophers  ---------------------------------
  ...
  class ForkMonitor
    ...
    fields
      ...
      lock: Mutex                          -- defined by me
      conditions: array [5] of Condition   -- defined by me
    methods
      Init ()
      Test(p: int)                         -- the method was added by me according to the book    
      PickupForks (p: int)
      PutDownForks (p: int)
      PrintAllStatus ()
  endClass
